...
install -D -m775 config/%{SOURCE1} %{buildroot}/usr/bin/harbour-spen-menu
install -D -m775 config/%{SOURCE2} %{buildroot}/usr/bin/evtest
install -D -m644 config/%{SOURCE3} %{buildroot}/usr/share/harbour-spen-menu/qml/harbour-spen-menu.qml
install -D -m644 config/%{SOURCE4} %{buildroot}/usr/share/harbour-spen-menu/qml/cover/CoverPage.qml
install -D -m644 config/%{SOURCE5} %{buildroot}/usr/share/harbour-spen-menu/qml/pages/Main.qml
install -D -m644 config/%{SOURCE6} %{buildroot}/usr/share/harbour-spen-menu/qml/pages/About.qml
install -D -m644 config/%{SOURCE7} %{buildroot}/%{_unitdir}/sailfishpen.service
install -D -m775 config/%{SOURCE8} %{buildroot}/usr/bin/droid/sailfishpen-daemon.sh
install -D -m775 config/%{SOURCE9} %{buildroot}/usr/bin/droid/sailfishpen-start-service.sh
install -D -m644 config/%{SOURCE10} %{buildroot}/usr/share/icons/hicolor/86x86/apps/harbour-sailfishpen.png
